        ...
        private List<Event> GetModeratedEvents()
        {
            var moderatedEvents = new List<Event>()
            {
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 09, 20, 23, 59, 59),
                ...
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 09, 28, 23, 59, 59),
                    Type = EventType.HelpNeeded,
                    IsOnline = false,
                ...
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 12, 14, 23, 59, 59),
                ...
                new()
                {
                    ...
                    StartingDate = new DateTime(2023, 09, 4),
                    EndingDate = new DateTime(2030, 10, 12, 23, 59, 59),
                    Type = EventType.HelpNeeded,
                    IsOnline = false,
                ...
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 10, 21, 23, 59, 59),
                    Type = EventType.HelpNeeded,
                    IsOnline = false,
                    IsModerated = true,
        ...
        private List<Event> GetUnmoderatedEvents()
        {
            var events = new List<Event>()
            {
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 09, 24, 23, 59, 59),
                    Type = EventType.HelpNeeded,
                    IsOnline = false,
                ...
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 11, 4, 23, 59, 59),
                    Type = EventType.HelpOffer,
                    IsOnline = true,
                ...
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 11, 1, 23, 59, 59),
                    Type = EventType.HelpNeeded,
                    IsOnline = false,
                ...
                new()
                {
                    ...
                    EndingDate = new DateTime(2030, 09, 17, 23, 59, 59),
                    Type = EventType.HelpOffer,
                    IsOnline = false,
                ...
                new()
                {
                    ...
                    StartingDate = new DateTime(2023, 09, 20),
                    EndingDate = new DateTime(2030, 09, 21, 23, 59, 59),
                    Type = EventType.HelpNeeded,
                    IsOnline = false,
